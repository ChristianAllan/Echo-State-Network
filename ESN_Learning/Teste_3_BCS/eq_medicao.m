function [ypk] = eq_medicao(x,u)

    % Estados
    pbh = x(1); pwh = x(2); q = x(3); fq = u(1); zc = u(2);
    ...
    P0 = -2.3599e9*q0^3 -1.8082e7*q0^2 +4.3346e6*q0 + 9.4355e4; % Binder et al. (2015)
    
    pin = pbh - rho*g*h1 - F1;  % Pintake
    H = CH*H0*(fq/f0)^2;        % Head
    P = Cp*P0*(fq/f0)^3;        % Potencia [W]
